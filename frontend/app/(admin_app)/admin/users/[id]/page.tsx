        ...
        <>
          ...
          <div>
            ...
            {cabinet.policies.length === 0 ? (
              <div className="p-8 border border-dashed border-gray-200 bg-gray-50 rounded-2xl text-center text-gray-500">
                This user has not uploaded any policies yet.
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {cabinet.policies.map(policy => (
                  <div key={policy.id} className="bg-white border border-gray-200 shadow-sm rounded-2xl p-6">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {policy.guarantees.map((g, i) => (
                          <li key={i} className="flex flex-col bg-gray-50 p-3 rounded-lg border border-gray-100">
            ...
            {cabinet.claims.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {cabinet.claims.map(claim => (
                  <div key={claim.id} className="bg-white border border-gray-200 shadow-sm rounded-2xl p-6">
