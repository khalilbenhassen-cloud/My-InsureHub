  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <main className="flex-grow">
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
              <div className="mb-12 lg:mb-0 lg:order-2 relative">
                ...
                <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-2xl bg-white transform rotate-1 hover:rotate-0 transition-transform duration-500 relative z-10">
                  ...
                  <img src="/screenshots/MyInsureHub - PolicyAssistant V2.JPG" alt="AI Policy Assistant Mockup" className="w-full h-auto object-cover" />
                </div>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
              <div className="mb-12 lg:mb-0 relative">
                ...
                <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-2xl bg-white transform -rotate-1 hover:rotate-0 transition-transform duration-500 relative z-10">
                  ...
                  <img src="/screenshots/MyInsureHub - Dashboard V2.JPG" alt="Dashboard Mockup" className="w-full h-auto object-cover" />
                </div>
              </div>
              <div>
                <h2 className="text-3xl font-bold text-brand-navy mb-6">{t('land_showcase1_title' as any)}</h2>
                <p className="text-lg text-slate-700 mb-8 leading-relaxed">
                  {t('land_showcase1_desc' as any)}
                </p>
                <Link href="/register" className="inline-flex items-center gap-2 text-brand-orange font-bold hover:opacity-80 transition-colors group">
                  {t('land_showcase1_link' as any)} <ChevronRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            </div>
          </div>
        ...
        {/* Showcase Section 3: Claims (Text Left, Image Right) */}
        <section className="bg-white py-24 border-t border-slate-100 overflow-hidden relative z-0">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
              <div className="mb-12 lg:mb-0 lg:order-2 relative">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] bg-[#F0F5F2] -z-10 transform rotate-[10deg] skew-x-[5deg] rounded-[4rem]"></div>
                
                <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-2xl bg-white transform rotate-1 hover:rotate-0 transition-transform duration-500 relative z-10">
                  <div className="bg-slate-100 border-b border-slate-200 px-4 py-2 flex items-center gap-2">
                    <div className="flex gap-1.5"><div className="h-2.5 w-2.5 rounded-full bg-red-400"></div><div className="h-2.5 w-2.5 rounded-full bg-amber-400"></div><div className="h-2.5 w-2.5 rounded-full bg-green-400"></div></div>
                  </div>
                  <img src="/screenshots/MyInsureHub - Claims V2.JPG" alt="Claims Management Mockup" className="w-full h-auto object-cover" />
                </div>
              </div>
              <div className="lg:order-1">
                <h2 className="text-3xl font-bold text-brand-navy mb-6">{t('land_showcase3_title' as any)}</h2>
                <p className="text-lg text-slate-700 mb-8 leading-relaxed">
                  {t('land_showcase3_desc' as any)}
                </p>
                <Link href="/register" className="inline-flex items-center gap-2 text-brand-orange font-bold hover:opacity-80 transition-colors group">
                  {t('land_showcase3_link' as any)} <ChevronRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            </div>
          </div>
        ...
        {/* Showcase Section 4: Assistance (Image Left, Text Right) */}
        <section className="bg-[#FDFBF7] py-24 border-t border-slate-100 overflow-hidden relative z-0">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
              <div className="mb-12 lg:mb-0 relative">
                <div className="absolute top-1/2 left-1/2 -translate-x-[40%] -translate-y-1/2 w-[150%] h-[150%] bg-[#F0F5F2] -z-10 transform -rotate-[10deg] skew-x-[-5deg] rounded-[4rem]"></div>
                
                <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-2xl bg-white transform -rotate-1 hover:rotate-0 transition-transform duration-500 relative z-10">
                  <div className="bg-slate-100 border-b border-slate-200 px-4 py-2 flex items-center gap-2">
                    <div className="flex gap-1.5"><div className="h-2.5 w-2.5 rounded-full bg-red-400"></div><div className="h-2.5 w-2.5 rounded-full bg-amber-400"></div><div className="h-2.5 w-2.5 rounded-full bg-green-400"></div></div>
                  </div>
                  <img src="/screenshots/MyInsureHub - Assistance V2.JPG" alt="Assistance Mockup" className="w-full h-auto object-cover" />
                </div>
              </div>
              <div>
                <h2 className="text-3xl font-bold text-brand-navy mb-6">{t('land_showcase4_title' as any)}</h2>
                <p className="text-lg text-slate-700 mb-8 leading-relaxed">
                  {t('land_showcase4_desc' as any)}
                </p>
                <Link href="/register" className="inline-flex items-center gap-2 text-brand-orange font-bold hover:opacity-80 transition-colors group">
                  {t('land_showcase4_link' as any)} <ChevronRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            </div>
          </div>
